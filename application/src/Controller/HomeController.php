...
class HomeController extends Controller
{
    ...
    {
        $projects = [
          ["title" => "projet1", "description" => "description projet 1"],
          ["title" => "projet2", "description" => "description projet 2"],
          ["title" => "projet3", "description" => "description projet 3"],
          ["title" => "projet4", "description" => "description projet 4"],
        ];
